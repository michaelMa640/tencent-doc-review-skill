...
class OpenAIClient:
    ...
    This is intentionally a minimal skeleton so the provider architecture is
    complete. Extend it when you decide the exact OpenAI models and response
    formatting rules the project should use.
    """
