...
- [x] 统一建议格式
- [x] 统一序列化逻辑
- 执行情况: [Phase4-审核结果模型统一](执行情况-v2/Phase4-审核结果模型统一.md)
...
- [x] 覆盖 provider 工厂
- [x] 覆盖报告输出
- 执行情况: [Phase5-测试与稳定性](执行情况-v2/Phase5-测试与稳定性.md)
...
- [x] 统一本地输入与腾讯文档输入
- [x] 补限流与错误处理
- 执行情况: [Phase6-腾讯文档读取接入](执行情况-v2/Phase6-腾讯文档读取接入.md)
...
- [x] 保留批注适配层
- [x] 明确原生批注为后续增强项
- 执行情况: [Phase7-结果写回策略](执行情况-v2/Phase7-结果写回策略.md)
...
- [x] 补示例命令
- [x] 整理 Docker 路径
- 执行情况: [Phase8-发布与交付](执行情况-v2/Phase8-发布与交付.md)
